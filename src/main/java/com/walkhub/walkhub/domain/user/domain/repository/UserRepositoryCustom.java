...
public interface UserRepositoryCustom {
    List<QueryUserListResponse.UserListInfo> queryUserList(Integer page, AuthorityScope scope, SortStandard sort, Integer grade, Integer classNum, User currentUser);
}
